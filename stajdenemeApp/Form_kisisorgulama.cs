    ...
    public partial class Form_kisisorgulama : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (entAile != null)
            {
                ...
                {
                    MessageBox.Show("İlgili kişi bulunamadı.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            else
            {
                MessageBox.Show("İlgili aile bulunamadı.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
